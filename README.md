...
| Car price<br/> prediction | Used car sales<br/> service want model<br/> to be built to<br/> predict cost of cars | Build model with<br/> RMSE metric<br/> lower than 2500 | `Pandas`, `NumPy`, `Sklearn`,<br/> `Matplotlib`, `Seaborn`,<br/> `Sklearn`, `LightGBM`
